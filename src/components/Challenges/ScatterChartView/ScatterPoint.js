...
class ScatterPoint extends Component {
  ...
  render() {
    ...
    return (
      <circle
        key={`item_${scatterItem.Seconds}_${scatterItem.Place}_${
          scatterItem.Nationality
        }`}
        r={5}
        cx={pos.x}
        cy={pos.y}
        fill={
          scatterItem.Doping === 'Doping Allegations' ? '#ed0909' : '#6caeac'
        }
...
ScatterPoint.propTypes = {
  ...
  scatterPointMouseEnter: PropTypes.func,
  scatterPointMouseLeave: PropTypes.func,
}
